...
export default function index() {
  const isActive = useNavStore((state) => state.isActive);
  const toggleActive = useNavStore((state) => state.toggleActive);

  return (
    <div className={styles.header}>
      <div className={styles.bar}>
        <Link className="hidden text-white md:flex" href="/">
          <div className=""> Drift | Ters</div>
        </Link>
        <div onClick={toggleActive} className={styles.el}>
          <div
